...
const decisionSuccessDuration = new Trend('decision_success_duration', true);
  ...
  return {
    ...
    scenarios: {
      concurrent_same_tag: {
        ...
        vus: envInt('VUS', 40),
        iterations: envInt('ITERATIONS', 40),
        maxDuration: env('MAX_DURATION', '30s'),
      },
    },
  };
}
...
export default function () {
  const payload = JSON.stringify({
    ...
    postUrl: env('POST_URL', 'http://127.0.0.1/posts/phase3a-concurrent'),
    tags,
